...
Dernière mise à jour : 2026-09-11 (parcours de confiance B, G, H, I) · 512 tests exécutés.
...
| Journey B — connexion                   | `connecter.test.tsx` (13 tests)                       | La connexion est refusée tant que le secret de récupération n'est pas créé **et** confirmé ; la connexion est éprouvée, jamais annoncée |
