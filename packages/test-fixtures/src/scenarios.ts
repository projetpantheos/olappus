...
const fact = (f: Omit<SyntheticFact, '_source'>): SyntheticFact => ({
  ...f,
...
export const SUBSCRIPTION_INCREASE: DemoScenario = {
...
export const TERMINATION_DEADLINE: DemoScenario = {
...
export const PRICE_VARIATION: DemoScenario = {
 ...
 */
export const NOTHING_TO_REPORT: DemoScenario = {
